...
// =========================================================================
// TYPESCRIPT DEFINITIONS (Fixes all 'skills' and implicit 'any' errors)
// =========================================================================
type Role = {
  title: string;
  period: string;
  ...
  desc: string;
  bullets: string[];
  skills?: string[]; // The '?' tells TypeScript this is optional
};
              ...
              <div className="md:col-span-3 space-y-12 border-l border-zinc-300 dark:border-zinc-800 pl-6 md:pl-10">
                {block.roles.map((role: Role, rIdx: number) => (
                  <div key={rIdx} className="space-y-4 relative group/role">
                    ...
                    {/* Render Skills array if it exists cleanly */}
                    {role.skills && (
