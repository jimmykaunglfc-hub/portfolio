...
export default function Home() {
  ...
  return (
    <main className="w-full max-w-7xl mx-auto px-4 md:px-8 pb-4 relative z-20">
      ...
      {/* SECTION 1: HOME (Hero)
        Web: Always visible. App: Visible only on Home tab.
      */}
      ...
      {/* SECTION 2: MATRIX COMPONENTS 
        Web: Always visible right below Hero. App: Visible only on Matrix tab.
        (Removed the duplicate hardcoded code from here!)
      */}
      ...
      {/* GLOBAL BOTTOM SECTIONS 
        These sit outside the tab logic so they always appear right above the footer 
