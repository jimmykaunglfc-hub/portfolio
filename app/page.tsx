...
const appGamesCache = [
  { id: 14, title: "Quantum Compass", slug: "quantum-compass", description: "Modern spin-the-bottle. Swipe to spin the holographic baton and select a random target.", specs: "Swipe Velocity Physics • Zero Setup", iconColor: "text-fuchsia-500 dark:text-fuchsia-400 bg-fuchsia-500/10 border-fuchsia-500/20" },
...
export default function HybridAppRouter() {
  ...
  return (
    <main className="portfolio-web w-full max-w-7xl mx-auto px-4 md:px-8 pt-6 pb-4 relative z-20">
      ...
      {/* 1. Hero Module Layer */}
      <div className="relative w-full min-h-[85vh] flex flex-col justify-center overflow-hidden mt-8 mb-16 rounded-sm bg-[#f2f5ff]/65 dark:bg-[#070b16] border border-[#0d1020]/10 dark:border-white/10">
        <DataNexus />
