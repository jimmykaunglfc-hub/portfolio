  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-6 left-4 right-4 z-50 pointer-events-none no-select">
        <nav className="pointer-events-auto flex justify-around items-center w-full max-w-sm mx-auto h-[4.5rem] px-2 bg-white/60 dark:bg-[#131315]/60 backdrop-blur-[32px] backdrop-saturate-200 border border-white/50 dark:border-white/10 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.12)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.8)]">
